...
# hotel.children.create_with(attributes).find_or_create_by(title: 'Facilities')
# hotel.children.create_with(attributes).find_or_create_by(title: 'Parking')
# hotel.children.create_with(attributes).find_or_create_by(title: 'Budget')
# hotel.children.create_with(attributes).find_or_create_by(title: 'Room')
